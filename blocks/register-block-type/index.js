...
const blockHeader = (
  <h2>{__("registerBlockType Explained", "jsforwphowto")}</h2>
);
...
export default registerBlockType(
  ...
  "jsforwp/register-demo",
  {
    ...
    description: __(
      "A demonstration block for learning how to register your own blocks with registerBlockType()",
      "jsforwphowto"
    ),
          ...
          <InspectorControls key="inspector">
            <PanelBody title={__("registerBlockType Setting", "jsforwphowto")}>
              <RadioControl
                ...
                options={[
                  {
                    label: __("Title and Description", "jsforwphowto"),
                  ...
                  {
                    label: __("Attributes", "jsforwphowto"),
                    value: "attributes"
                  },
